...
<!-- Promo Block - Slider -->
	<div class="js-carousel" data-autoplay="true" data-infinite="true" data-fade="true" data-speed="5000">
		<div class="js-slide g-min-height-100vh g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(../../assets/img-temp/1920x1080/img20.jpg);"></div>

		<div class="js-slide g-min-height-100vh g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(../../assets/img-temp/1920x1080/img17.jpg);"></div>
	</div>
		...
		<!-- Article Content -->
			<div class="col-lg-6 g-mb-30">
				...
				<div class="g-pl-90--sm">
					...
					<div class="d-flex">
						<!-- Video Bock -->
						<div class="u-shadow-v21 g-bg-img-hero g-pos-rel g-height-160 g-width-300 rounded" style="background-image: url('../../assets/img-temp/400x270/img1.jpg');" data-bg-img-src="../../assets/img-temp/400x270/img1.jpg">
...
<section class="text-center">
	...
	<div class="row align-items-stretch no-gutters g-bg-black-opacity-0_9 g-min-height-80vh" style="background-image: url('../../assets/img/bg/pattern3.png');">
		...
		<div class="col-lg-6 align-self-center g-pa-100">
			<img class="g-width-70 g-height-70 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
	...
	<div class="container">
		...
		<div class="g-bg-img-hero g-pb-70" style="background-image: url(../../assets/img/maps/map3.png);">
			<div class="row justify-content-center g-pt-100--md">
				...
				<div class="col-md-6 col-lg-4 g-hidden-sm-down g-bg-size-cover g-min-height-300 g-pos-rel rounded g-top-minus-70 g-ml-minus-50" data-bg-img-src="../../assets/img-temp/900x900/img2.jpg"></div>
			</div>
		</div>
