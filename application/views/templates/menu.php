		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				...
				<a href="<?php base_url(); ?>inicio" class="navbar-brand">
					<img src="<?php base_url(); ?>assets/img/logo/logo_metrocert.gif" alt="metrocert">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
					<ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
						...
						<li class="nav-item g-mx-20--lg">
							<a href="#evaluacionInsumos" class="nav-link px-0">Evaluación de Insumos</a>
						</li>
						<li class="nav-item g-mx-20--lg">
							<a href="#documentos" class="nav-link px-0">Documentos</a>
						</li>
						<li class="nav-item g-mx-20--lg">
							<a href="#sitiosInteres" class="nav-link px-0">Sitios de interes</a>
						</li>
